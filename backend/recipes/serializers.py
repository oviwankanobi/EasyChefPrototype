...
class StepSerializer(serializers.ModelSerializer):
    ...
    def get_images(self, step):
        ...
        data = [{'id': img.id, 'image': "http://127.0.0.1:8000/media/" +
                 str(img.image)} for img in queryset]
    ...
    def get_videos(self, step):
        ...
        data = [{'id': vid.id, 'video': "http://127.0.0.1:8000/media/" +
                 str(vid.video)} for vid in queryset]
...
class ShowRecipeSerializer(serializers.ModelSerializer):
    ...
    def get_ingredients(self, recipe):
        ...
        data = [{'id': ingr.id, 'base_id': ingr.base_ingredient.id,  'name': str(
            ingr.base_ingredient), 'quantity': ingr.quantity} for ingr in queryset]
