...
urlpatterns = [
    ...
    # did user favorite a recipe
    path('is-favorited/<int:recipe_id>/',
         IsRecipeFavoritedByUser.as_view(), name='did-user-favorite'),

    # did user rate a recipe
    path('is-rated/<int:recipe_id>/',
         IsRecipeRatedByUser.as_view(), name='did-user-rate'),

    # update user rating
    path('update-rating/<int:recipe_id>/',
         UpdateUserRating.as_view(), name='update-user-rating'),
    ...
    path('add-ingredient-to-recipe/<int:recipe_id>/',
         AddIngredientView.as_view()),
    path('delete-ingredient-from-recipe/<int:ingredient_id>/',
    ...
    path('delete-image-from-recipe/<int:image_id>/',
         DeleteImageRecipeView.as_view()),
    path('delete-video-from-recipe/<int:video_id>/',
         DeleteVideoRecipeView.as_view()),
    path('delete-image-from-step/<int:image_id>/',
         DeleteImageStepView.as_view()),
    path('delete-video-from-step/<int:video_id>/',
         DeleteVideoStepView.as_view()),
    ...
    path('remove-recipe-from-cart/<int:recipe_id>/',
    ...
    path('<int:recipe_id>/average-rating/',
         GetRecipeAverageRatingView.as_view()),
