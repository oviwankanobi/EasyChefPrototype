    ...
    return (
        <>
            <div className="container">
                ...
                <ShoppingCartRecipes cart={shoppingCart} setRemoveErrors={setRemoveErrors}/>
                {loginError && <Alert variant="danger">Please check if you are logged in, then try again.</Alert>}
